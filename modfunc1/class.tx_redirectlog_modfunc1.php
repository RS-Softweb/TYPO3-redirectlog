...
/**
 * Module extension (addition to function menu) 'Redirections log' for the 'redirectlog' extension.
 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/redirectlog/modfunc1/class.tx_redirectlog_modfunc1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/redirectlog/modfunc1/class.tx_redirectlog_modfunc1.php']);
}
